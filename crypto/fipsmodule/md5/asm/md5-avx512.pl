#!/usr/bin/perl -w
#
# MD5 optimized for AVX-512.
#
# Original Author: Marc Bevand <bevand_m (at) epita.fr>
# Licence: I hereby disclaim the copyright on this code and place it
# in the public domain.
#
# AVX-512 version written by Dan Pittman <daniel.pittman (at) intel.com>
...
.globl md5_block_avx512_data_order
.type md5_block_avx512_data_order,\@function,3
md5_block_avx512_data_order:
.cfi_startproc
	push	%rbp
.cfi_push	rbp
	push	%rbx
...
.Lepilogue:
	ret
.cfi_endproc
.size md5_block_avx512_data_order,.-md5_block_avx512_data_order
EOF
